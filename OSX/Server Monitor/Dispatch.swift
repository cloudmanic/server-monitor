...
//  Server Monitor
//
//  Created by Spicer Matthews on 7/12/16.
...
extension Dispatch {
    ...
    public static func async(queue: dispatch_queue_t = dispatch_queue_create("com.cloudmanic.servermonitor.async", DISPATCH_QUEUE_SERIAL), delay: Double = 0.0, block: Block) {
...
extension Dispatch {
    ...
    public static func timerAsync(queue: dispatch_queue_t = dispatch_queue_create("com.cloudmanic.servermonitor.async", DISPATCH_QUEUE_SERIAL), interval: Double, block: Block) -> dispatch_source_t {
